...
import { sanitizeOpenNextEnvPaths } from './sanitize-open-next-env.mjs';
...
execFileSync('cp', ['-R', sourceDir, targetDir], { stdio: 'inherit' });
...
sanitizeOpenNextEnvPaths([path.join(targetDir, 'cloudflare/next-env.mjs')]);

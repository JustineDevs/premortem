import { SMOKE_GEMINI_MODEL as DEFAULT_SMOKE_GEMINI_MODEL, allowsForceLocalIngest } from '../../packages/domain/src/index.ts';
import { splitIssueCandidate } from '../../packages/db/src/index.ts';
import {
...
import { bootstrapPremortemAgentMission } from '../../services/agent-builder/src/index.ts';
import {
  buildGraphFromIngestion,
  clusterFindings,
  ingestGitLabProject,
  EMPTY_CI_HISTORY
} from '../../services/orchestrator/src/index.ts';
...
async function probeGitLabMcpEndpoint(baseUrl: string) {

# AI Security Arsenal (Premortem)

Installed from [hardw00t/ai-security-arsenal](https://github.com/hardw00t/ai-security-arsenal) under `.agents/skills/security/`. Cursor bridge: `.cursor/skills/llm-security` for the LLM skill; use `.cursor/skills/vet` for trust-boundary gates.

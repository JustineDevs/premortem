...
export const integrationConnectOptions: IntegrationConnectOption[] = [
  ...
  },
  {
    id: "github",
    name: "GitHub",
    description: "GitHub connector is on the roadmap.",
    status: "coming_soon",
  ...
  },
  {
    id: "bitbucket",
    name: "Bitbucket",
    description: "Bitbucket connector is on the roadmap.",
    status: "coming_soon",
  ...
  },
  {
    id: "azure-devops",
    name: "Azure DevOps",
    description: "Azure DevOps connector is on the roadmap.",
    status: "coming_soon",
  ...
  },
  {
    id: "gitea",
    name: "Gitea",
    description: "Gitea connector is on the roadmap.",
    status: "coming_soon",
    scopes: "repo, user",
  },
];

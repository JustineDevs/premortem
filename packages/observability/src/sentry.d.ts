...
export declare function initServerObservability(serviceName: string): Promise<void>;
...
export declare function probeSentryDelivery(serviceName?: string, message?: string): Promise<void>;
